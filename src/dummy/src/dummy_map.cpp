...
class DummyMapPublisher : public rclcpp::Node {
  public:
    DummyMapPublisher() : rclcpp::Node("dummy_map_publisher") {
        ...
        this->timer_ = this->create_wall_timer(100ms, std::bind(&DummyMapPublisher::timer_callback, this));
  ...
  private:
    ...
    void timer_callback() {
        ...
        std::cout << "Value before editing is: " << this->dummy_message_update->data[this->counter_ % 10000]
                  << std::endl;
        this->dummy_message_update->data[this->counter_ % 10000] = 100;
        std::cout << "Value after editing is: " << this->dummy_message_update->data[this->counter_ % 10000]
                  << std::endl;
